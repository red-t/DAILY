...
PATH_ANNO="/data/tusers/yutianx/tongji2/GitHuB/piSet/annotation/dm3"
BWA_INDEX=${PATH_ANNO}/BWAIndex/genome
GENOME_FA=${PATH_ANNO}/dm3.fa
TE_FA=${PATH_ANNO}/dm3.transposon.fa
TE_BED6=${PATH_ANNO}/dm3.rmsk.bed

# Process the data
echo "Running TEMP2 insertion for ${PREFIX}"
mkdir ${PREFIX}
